  ...
  return (
    ...
    <div className="modal">
          ...
          <div className="modal-content ">
            ...
            <div className="flex">
            <button className="border m-auto border-gray-500 bg-zinc-300  rounded-3xl pt-1 pb-1 pl-2 pr-2 hover:bg-zinc-400 float-right" onClick={()=>{toggleConfirmChanges(); handleConfirmChanges();}}>
              confirm
            </button>
