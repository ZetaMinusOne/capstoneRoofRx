...
export default function PersonalInformationPage() {
  ...
  useEffect (() =>{
    const fetchData = async () => {
      setIsLoading(true)
      try{
        const url = 'https://zs9op711v1.execute-api.us-east-1.amazonaws.com/dev/users/32';
  ...
  const handleUpdate = async () => {
    const url = `https://zs9op711v1.execute-api.us-east-1.amazonaws.com/dev/users/32`; // Make sure URL is correct
    const data = {
        FirstName: personalInfo.firstName,
        LastName: personalInfo.lastName,
        PhoneNumber: personalInfo.phoneNumber,
        Signature_URL: personalInfo.signature,
    };
  ...
  return (
    <>
            ...
            <div className="flex flex-col items-center w-full gap-7">
              ...
              <div className="flex flex-col items-center w-full gap-7 ">
                ...
                <div className="flex flex-col items-start gap-[9px] w-full max-w-[500px] border h-[250px]">
                  {(url !== undefined) && <img src={url} alt="signature" style={{ width: "500px", height: "250px" }} />}
                </div>
                <button
      ...
      {activeModal && <Modal toggleModal={() => setActiveModal(!activeModal)} errorModal={errorModal} toggleConfirmChanges={() => setConfirmChanges(!confirmChanges)} confirmChanges={confirmChanges} handleUpdateProfile={() => handleUpdateProfile()} />}
