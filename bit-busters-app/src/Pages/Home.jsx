...
// Define the background style with color and image
...
export default function MainpagePage() {
  ...
  return (
    <>
      ...
      <div className="flex md:flex-col justify-between items-start w-full pr-8 gap-5 sm:pr-5 " style={backgroundStyle}>
        <Sidebar1
          isAdmin={isAdmin}
          className="flex flex-col w-[78px] h-screen gap-6 top-0 py-3 bg-indigo-700 !sticky overflow-auto"
        />
        <div className="flex justify-center w-full md:w-full ml-[300px] ">
          <div className="flex flex-col  gap-7 justify-center w-[100%] md:w-full">
            <div className="flex md:flex-col justify-end items-start ml-[738px] gap-[23px] md:ml-0 relative">
              <div className="flex justify-end w-[100%] md:w-full items-start gap-[2px] absolute top-0 left-7">
                <DropdownMenu />
              </div>
            </div>
            <div className="flex md:flex-col w-[88%] md:w-full justify-center items-center gap-[198px]" style={{ marginTop: '200px' }}>
              <div className="flex flex-col w-full md:p-5 rounded-[20px]" style={{ marginBottom: '150px' }}>
                <Button
                  size="lg"
                  className="h-[401px] leading-4 min-w-[401px] rounded-[20px] dark_navy_blue hover:bg-blue-500 focus:outline-none focus:bg-blue-900 shadow-md text-white font-bold"
                  onClick={() => {
